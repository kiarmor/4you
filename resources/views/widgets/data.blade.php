...
@stop
@section('page-script')
<script src="{{asset('assets/bundles_new/countTo.bundle.js')}}"></script>
<script src="{{asset('assets/bundles_new/knob.bundle.js')}}"></script>
<script src="{{asset('assets/bundles_new/sparkline.bundle.js')}}"></script>
<script src="{{asset('assets/js_new/pages/widgets/infobox/infobox-1.js')}}"></script>
<script src="{{asset('assets/js_new/pages/charts/jquery-knob.js')}}"></script>
<script src="{{asset('assets/js_new/pages/charts/sparkline.js')}}"></script>
@stop