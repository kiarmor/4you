...
<script src="{{asset('assets/bundles_new/fullcalendarscripts.bundle.js')}}"></script>
<script src="{{asset('assets/js_new/pages/medias/image-gallery.js')}}"></script>
<script src="{{asset('assets/js_new/pages/calendar/calendar.js')}}"></script>
@stop
